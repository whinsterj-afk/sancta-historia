-- Compare values using the storage type of ecclesiastical_sites.min_zoom.
-- Without this cast, decimal thresholds such as 3.2 stored as real can be
-- microscopically greater than the same value received as double precision.
...
as $$
  ...
  where site.is_published
    ...
    and site.min_zoom <= map_zoom::real
    and (
